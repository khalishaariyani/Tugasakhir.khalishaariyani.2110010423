  ...
  begin
    ShowMessage('POIN ID SEMESTER TIDAK BOLEH KOSONG!');
      ...
      begin
        ...
        ZQuery1.SQL.Add('insert into wali_klelas values(null,"'+edt1.Text+'","'+edt2.Text+'","'+edt3.Text+'","'+edt4.Text+'","'+edt5.Text+'","'+edt6.Text+'","'+edt7.Text+'","'+edt8.Text+'") ');
        ZQuery1.ExecSQL ;

        ZQuery1.SQL.Clear;
        ZQuery1.SQL.Add('select * from wali_klelas');
        ZQuery1.Open;
...
ZQuery1.SQL.Clear;
ZQuery1.SQL.Add('Update wali_klelas set nik= "'+edt1.Text+'",nama="'+edt2.Text+'",jenis_kelamin= "'+edt3.Text+'",pendidikan= "'+edt4.Text+'",telp= "'+edt5.Text+'",matpel= "'+edt6.Text+'",alamat= "'+edt7.Text+'",status= "'+edt8.Text+'"where id="'+id+'"');
ZQuery1.ExecSQL;
...
begin
  ZQuery1.SQL.Clear;
  ZQuery1.SQL.Add('delete from wali_klelas where id="'+id+'"');
  ZQuery1.ExecSQL;
  ZQuery1.SQL.Clear;
  ZQuery1.SQL.Add('select * from wali_klelas');
  ZQuery1.Open;
